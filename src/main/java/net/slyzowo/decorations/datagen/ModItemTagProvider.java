...
public class ModItemTagProvider extends ItemTagProvider {
  ...
  protected void configure(RegistryWrapper.WrapperLookup lookup) {
    ...
    getOrCreateTagBuilder(ItemTags.PLANKS)
            ...
            .add(ModBlocks.PALE_OAK_DINING_CHAIR.asItem())
            .add(ModBlocks.STRIPPED_PALE_OAK_DINING_CHAIR.asItem())
            ...
            .add(ModBlocks.PALE_OAK_LADDERBACK_CHAIR.asItem())
            .add(ModBlocks.STRIPPED_PALE_OAK_LADDERBACK_CHAIR.asItem())
