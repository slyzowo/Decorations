...
public class ModModelProvider extends FabricModelProvider {
  ...
  public void generateBlockStateModels(BlockStateModelGenerator blockStateModelGenerator) {
    ...
    blockStateModelGenerator.registerSimpleCubeAll(ModBlocks.OAK_TABLE);
    blockStateModelGenerator.registerSimpleCubeAll(ModBlocks.STRIPPED_OAK_TABLE);
    blockStateModelGenerator.registerSimpleCubeAll(ModBlocks.SPRUCE_TABLE);
    blockStateModelGenerator.registerSimpleCubeAll(ModBlocks.STRIPPED_SPRUCE_TABLE);
    blockStateModelGenerator.registerSimpleCubeAll(ModBlocks.BIRCH_TABLE);
    blockStateModelGenerator.registerSimpleCubeAll(ModBlocks.STRIPPED_BIRCH_TABLE);
    blockStateModelGenerator.registerSimpleCubeAll(ModBlocks.JUNGLE_TABLE);
    blockStateModelGenerator.registerSimpleCubeAll(ModBlocks.STRIPPED_JUNGLE_TABLE);
    blockStateModelGenerator.registerSimpleCubeAll(ModBlocks.ACACIA_TABLE);
    blockStateModelGenerator.registerSimpleCubeAll(ModBlocks.STRIPPED_ACACIA_TABLE);
    blockStateModelGenerator.registerSimpleCubeAll(ModBlocks.DARK_OAK_TABLE);
    blockStateModelGenerator.registerSimpleCubeAll(ModBlocks.STRIPPED_DARK_OAK_TABLE);
    blockStateModelGenerator.registerSimpleCubeAll(ModBlocks.MANGROVE_TABLE);
