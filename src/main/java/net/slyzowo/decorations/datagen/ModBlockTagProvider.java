...
public class ModBlockTagProvider extends FabricTagProvider.BlockTagProvider {
  ...
  protected void configure(RegistryWrapper.WrapperLookup wrapperLookup) {
    ...
    getOrCreateTagBuilder(BlockTags.AXE_MINEABLE)
            ...
            .add(ModBlocks.STRIPPED_OAK_STOOL)
            .add(ModBlocks.SPRUCE_STOOL)
            .add(ModBlocks.STRIPPED_SPRUCE_STOOL)
            .add(ModBlocks.BIRCH_STOOL)
            .add(ModBlocks.STRIPPED_BIRCH_STOOL)
            .add(ModBlocks.JUNGLE_STOOL)
            .add(ModBlocks.STRIPPED_JUNGLE_STOOL)
            .add(ModBlocks.ACACIA_STOOL)
            .add(ModBlocks.STRIPPED_ACACIA_STOOL)
            .add(ModBlocks.DARK_OAK_STOOL)
            .add(ModBlocks.STRIPPED_DARK_OAK_STOOL)
            .add(ModBlocks.MANGROVE_STOOL)
            .add(ModBlocks.STRIPPED_MANGROVE_STOOL)
            .add(ModBlocks.CHERRY_STOOL)
            .add(ModBlocks.STRIPPED_CHERRY_STOOL)
            .add(ModBlocks.BAMBOO_STOOL)
            .add(ModBlocks.STRIPPED_BAMBOO_STOOL)
            .add(ModBlocks.CRIMSON_STOOL)
            .add(ModBlocks.STRIPPED_CRIMSON_STOOL)
            .add(ModBlocks.WARPED_STOOL)
            .add(ModBlocks.STRIPPED_WARPED_STOOL);
