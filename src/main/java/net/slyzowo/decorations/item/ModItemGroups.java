  ...
  Identifier.of(Decorations.MOD_ID, "decorations_group"),
          FabricItemGroup.builder()
                  ...
                  .entries(((displayContext, entries) -> {
                    ...
                    entries.add(ModBlocks.STRIPPED_OAK_STOOL);
                    ...
                    entries.add(ModBlocks.STRIPPED_SPRUCE_STOOL);
                    ...
                    entries.add(ModBlocks.STRIPPED_BIRCH_STOOL);
                    ...
                    entries.add(ModBlocks.STRIPPED_JUNGLE_STOOL);
                    ...
                    entries.add(ModBlocks.STRIPPED_ACACIA_STOOL);
                    ...
                    entries.add(ModBlocks.STRIPPED_DARK_OAK_STOOL);
                    ...
                    entries.add(ModBlocks.STRIPPED_MANGROVE_STOOL);
                    ...
                    entries.add(ModBlocks.STRIPPED_CHERRY_STOOL);
                    ...
                    entries.add(ModBlocks.STRIPPED_BAMBOO_STOOL);
                    ...
                    entries.add(ModBlocks.STRIPPED_CRIMSON_STOOL);
                    ...
                    entries.add(ModBlocks.STRIPPED_WARPED_STOOL);
